...
if ( ! function_exists( 'theme_test_setup' ) ) :
	/**
	...
	function theme_test_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'theme_test_custom_background_args', array(
...
function theme_test_scripts() {
	wp_enqueue_style( 'theme-test-style', get_stylesheet_uri() );

	wp_enqueue_script( 'theme-test-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'theme-test-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
